...
const Skills = () => {
  return (
    <div className='relative'>
      ...
      <div
        id='skills'
        className='absolute top-0 left-0 h-screen flex flex-col justify-center items-center gap-2  text-neutral-100 '
      >
        <h1
          style={{ textShadow: '3px 3px 3px black ' }}
          className='text-4xl text-neutral-200 font-thin selection:bg-orange-500'
        >
          So what do I <span className='font-semibold'>know</span> ?
        </h1>
        <div className='w-2/3 text-xl font-light text-shadow-sm selection:bg-indigo-700'>
        ...
        <div className='font-medium text-shadow-sm selection:bg-red-600'>
