...
const SideBar = () => {
  return (
    <div className='hidden w-1/5 h-screen md:flex flex-col items-center text-sm lg:text-base text-neutral-100 text-shadow-sm bg-cyan-400 brightness-95 py-12 gap-12'>
