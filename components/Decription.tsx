...
const Decription = () => {
  return (
    <div className='before:absolute before:h-screen before:w-full before:bg-blue-600 before:blur-sm relative'>
      {/* <div className='h-screen w-full bg-blue-600 blur-sm'></div> */}
      <div
        id='decription'
        className='flex flex-col h-screen justify-center items-center gap-2 relative'
      >
        <h1
